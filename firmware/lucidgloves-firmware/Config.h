...
//(This configuration is for Faemod so make sure to change if you're on another board)
...
#define PINS_MUX_SELECT     '/0',  /*S0 pin*/ \
                            '/0',  /*S1 pin*/ \
                            '/0',  /*S2 pin*/ \
                            '/0'   /*S3 pin (if your mux is 3-bit like 74HC4051 then you can remove this line and the backslash before it.)*/

#define MUX_INPUT '/0'  //the input or SIG pin of the multiplexer. This can't be a mux pin.
